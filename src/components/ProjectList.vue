      ...
      <table class="table table-striped">
        ...
        <tbody>
          <tr v-for="(project, index) in projects" :key="index">
            ...
            <td>
              <button id="editBtn" class="btn btn-sm" @click="editProject(index)"><i class="bi bi-pencil-square"></i></button>
              <button id="deleteBtn" class="btn btn-sm" @click="deleteProject(index)"><i class="bi bi-trash"></i></button>
            </td>
          </tr>
        </tbody>
      </table>
